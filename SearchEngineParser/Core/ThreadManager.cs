...
namespace SearchEngineParser.Core
{
    ...
    {
        protected static ILog _logger = LogManager.GetLogger("SearchEngineParser");
        ...
        {
            if ((maxThreads > 500) || (maxThreads < 1))
                throw new ArgumentException("MaxThreads must be from 1 to 500");
